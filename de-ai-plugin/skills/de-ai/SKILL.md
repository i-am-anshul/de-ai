...
description: |
  ...
  or generating text to make it sound natural and human-written. Applies to all
  content: resumes, cover letters, LinkedIn posts, professional writing, documentation.
  Detects and fixes: inflated symbolism, promotional language, superficial analyses,
  vague attributions, em dash overuse, rule of three, AI vocabulary, negative
  parallelisms, excessive hedging, and sycophantic tone.
---
